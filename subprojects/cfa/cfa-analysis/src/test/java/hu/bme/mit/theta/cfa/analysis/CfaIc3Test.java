...
import hu.bme.mit.theta.cfa.analysis.ic3.CarCFAChecker;
import hu.bme.mit.theta.cfa.analysis.ic3.Ic3CFAChecker;
...
public class CfaIc3Test {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
                new Object[][] {
                    {
                        "src/test/resources/arithmetic-bool00.cfa",
                        PRED_CART,
                        SEQ_ITP,
                        false,
                        15,
                    ...
                    {
                        "src/test/resources/arithmetic-bool01.cfa",
                        PRED_CART,
                        SEQ_ITP,
                        false,
                        15,
                    ...
                    {
                        "src/test/resources/arithmetic-bool10.cfa",
                        PRED_BOOL,
                        SEQ_ITP,
                        false,
                        15,
                    ...
                    {
                        "src/test/resources/arithmetic-bool11.cfa",
                        PRED_CART,
                        SEQ_ITP,
                        false,
                        15,
                    ...
                    {
                        "src/test/resources/arithmetic-int.cfa",
                        PRED_BOOL,
                        BW_BIN_ITP,
                        false,
                        13,
                    ...
                    {
                        "src/test/resources/counter_bv_true.cfa",
                        EXPL,
                        SEQ_ITP,
                        true,
                        0,
                    ...
                    {
                        "src/test/resources/counter_bv_false.cfa",
                        EXPL,
                        SEQ_ITP,
                        false,
                        13,
    ...
    public void test() throws Exception {
        ...
        try {
            ...
            Ic3CFAChecker ic3CFAChecker = new Ic3CFAChecker(cfa,solverFactory, NullLogger.getInstance());
            SafetyResult<?, ?> result = ic3CFAChecker.check();
