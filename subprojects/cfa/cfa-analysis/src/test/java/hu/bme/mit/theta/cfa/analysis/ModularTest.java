...
import hu.bme.mit.theta.cfa.analysis.ic3.ModularChecker;
...
public class ModularTest {
    ...
    public void test() throws Exception {
        ...
        try {
            ...
            ModularChecker modularChecker = new ModularChecker(cfa,solverFactory, NullLogger.getInstance());
            SafetyResult<?, ?> result = modularChecker.check();
