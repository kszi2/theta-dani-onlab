...
public class Ic3Checker implements SafetyChecker {
    ...
    public Ic3Checker(MonolithicExpr monolithicExpr, SolverFactory solverFactory, boolean formerFramesOpt, boolean unSatOpt, boolean notBOpt, boolean propagateOpt, boolean filterOpt) {
    ...
    public SafetyResult check(Prec prec) {
        ...
        while (true) {
            ...
            if (counterExample != null) {
                Trace trace = tryBlock(new ProofObligation(new HashSet<>(counterExample), i));
                if (trace != null) {
